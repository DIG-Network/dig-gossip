...
fn test_full_import_set() {
    ...
    use dig_gossip::{
        ...
        IntroducerPeers, DigMessage, Network, NewPeak, NewTransaction, NewUnfinishedBlock, NodeType,
        DigLink, PeerConnection, PeerConnectionWireMetrics, PeerId, PeerIdRotationConfig, PeerInfo,
        LinkOptions, PeerReputation, PenaltyReason, ProtocolMessageTypes, RateLimit, OpcodeRateLimiter,
