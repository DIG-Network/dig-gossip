...
- [x] CON-005 — Rate limiting (RateLimiter with V2_RATE_LIMITS, DIG extensions)
...
- [ ] DSC-009 — Parallel connection establishment (batch connect with FuturesUnordered) — planned
...
- [x] DSC-012 — IntroducerPeers/VettedPeer tracking (vetting state machine)
...
- [x] RLY-004 — Relay auto-reconnect with exponential backoff
- [x] RLY-005 — Relay peer list (GetPeers/Peers exchange)
- [x] RLY-006 — Relay keepalive (Ping/Pong)
- [x] RLY-007 — NAT traversal hole punching via relay coordination
- [x] RLY-008 — Transport selection (direct P2P first, relay fallback, prefer_relay override)
...
- [ ] PRF-004 — Parallel bootstrap (PARALLEL_CONNECT_BATCH_SIZE concurrent connects) — planned
