...
### Bug Fixes
- **limits:** Opcode 226 DISTRIBUTOR_ANNOUNCE is a public flood (#97)

## [0.33.0] - 2026-09-13

### Features
- DISTRIBUTOR_ANNOUNCE (opcode 226) wire, dig-peer-protocol 0.10 (#95)
...
### Documentation
- Add CONTRIBUTING.md (#87)

## [0.32.0] - 2026-08-29

### Features
- **pool:** Direct-inbound adoption entry point (#3124) (#83)
...
### Features
- **pool:** Retire a superseded observed session, and cycle an idle peer for a discovered one (#73)

## [0.26.0] - 2026-08-19

### Features
- **pool:** Adopt a relayed inbound circuit by liveness handle, not by connection (#70)

## [0.25.0] - 2026-08-17

### Bug Fixes
- **gossip:** Repeat announces reach the wire, NAT peers receive broadcasts, count is honest (#67)
...
### Features
- **deps:** Delete the vendored chia-protocol and chia-sdk-client forks (#63)
...
### Documentation
- Regenerate vendor fork deltas from fork-delta.sh (#59)

## [0.22.0] - 2026-08-08

### Features
- **pool:** Adopt an authenticated relayed INBOUND circuit into the connected-peer pool (#54)
...
### Refactor
- **connection:** Extract the DIG rate limiter out of the vendored chia-sdk-client fork (#58)

## [0.20.0] - 2026-08-06

### Features
- **gossip:** Advertise the configured software version on the handshake in both directions (#56)

## [0.19.1] - 2026-08-05

### Bug Fixes
- **peer-pool:** Stop re-dialing already-connected peers (cross-key-space miss) (#55)

## [0.19.0] - 2026-08-02

### Features
- **relay-wire:** RLY-009 DHT records + non_exhaustive; dig-nat 0.18 (#53)

## [0.18.1] - 2026-08-01

### CI
- Re-lock on release and gate Cargo.lock drift with --locked (#52)

## [0.18.0] - 2026-07-31

### Bug Fixes
- **error:** Hold relay-supplied text as SafeText, bump dig-nat to 0.15 (#51)
...
### Bug Fixes
- **svc:** Guard plumtree.remove_peer against the reconnect window in disconnect() + reaper (#47)
...
### Documentation
- **spec:** Record the rate-limit ban async-gap as an accepted residual (#45)
...
### Testing
- **con:** Expose transport Capacity rejection distinctly + deterministic test (#36)
...
### Bug Fixes
- **con:** Let this node re-dial a peer with a stale outbound slot (outbound newest-wins, #1703)

## [0.17.1] - 2026-07-27

### Bug Fixes
- **con:** Let a restarted peer reconnect (newest-wins over a stale slot) (#1691)
...
### Chores
- **deps:** Bump dig-nat to 0.13 — release 0.16.0 (cascade #1656) (#25)

## [0.15.2] - 2026-07-25

### Bug Fixes
- Reject self peer_id on outbound pool-add paths (#1584) (#24)

## [0.15.1] - 2026-07-24

### Bug Fixes
- **dig-gossip:** Connect_to publishes PoolEvent::PeerAdded so direct peers reach DHT routing (#1581) (#23)
