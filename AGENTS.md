...
This project is indexed by GitNexus as **dig-gossip** (4459 symbols, 9520 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
